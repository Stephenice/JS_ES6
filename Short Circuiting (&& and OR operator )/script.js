...
// || operator: its evaluate the value from the left to the right looking for the truthy value but if no values is truthy the last values will be th result.
...
console.log(0 || null); //result null because both values are falsy values so the last values will be the result
